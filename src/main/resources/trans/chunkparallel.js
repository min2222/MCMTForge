    ...
    return {
        'chunkLoadCache': {
            ...
            'transformer': function(classNode) {
            	...
            	var targetMethodName = asmapi.mapMethod("m_7587_");
            	var targetMethodDesc = "(IILnet/minecraft/world/level/chunk/ChunkStatus;Z)Lnet/minecraft/world/level/chunk/ChunkAccess;";
            	...
            	for (var i in methods) {
            		...
            		var jumpStartMethod = asmapi.mapMethod("m_45589_");
            		var jumpStartClass = "net/minecraft/world/level/ChunkPos";
