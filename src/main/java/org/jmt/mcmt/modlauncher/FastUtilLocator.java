...
public class FastUtilLocator implements IModLocator {
	...
	public List<ModFileOrException> scanMods() {
		...
		List<ModFileOrException> imf = new ArrayList<ModFileOrException>();
		try {
			...
			((Jar)sj).getManifest().getMainAttributes().putValue("FMLModType", "GAMELIBRARY");
			ModFile mf = new ModFile(sj, this, FastUtilLocator::modfileinfoinator);
			System.out.println("SUPERTEST9001 TEST:" + mf.getType());
			imf.add(new ModFileOrException(mf, new ModFileLoadingException("Invalid Mod File")));
